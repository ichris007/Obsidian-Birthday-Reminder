...
[English](https://github.com/ichris007/Obsidian-Birthday-Reminder/) | [中文文档](https://github.com/ichris007/Obsidian-Birthday-Reminder/blob/main/README-ZH.md)
...
#### 方法二：手动安装：
1. 从 [Releases](https://github.com/ichris007/Obsidian-Birthday-Reminder/releases) 下载最新版本的`main.js`、`manifest.json`、`styles.css
`
...
- ✨ 新增功能
    - 完整支持英文界面，生肖、星座、农历日期、年龄单位全部英文化
    - 根据语言设置动态显示界面文本

- 🐛 Bug 修复
    - 修复英文版本中生肖、星座仍显示中文的问题
    - 修复年龄单位在英文环境下仍显示"岁"的问题
